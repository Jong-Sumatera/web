...
import { bannerPrivacy } from "../public/images";
        ...
        <div>
            <Navbar />
               <Banner2 
                  ...
                  description={'Learn more about how Privacy Police collects and uses data and your rights as a Privacy Police user.'}
                  image={bannerPrivacy}
               />
               <DocsContent>
               <p>Effective date: 2022-08-31<br />
               <br />
               <strong className="text-[20px]">1. Introduction</strong><br />
               <br />
               Welcome to LearnUp.<br />
               <br />
               LearnUp (&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates learnupindonesia.com (hereinafter referred to as &ldquo;Service&rdquo;).<br />
               <br />
               Our Privacy Policy governs your visit to learnupindonesia.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.<br />
               <br />
               ...
               <br />
               Our Terms and Conditions (&ldquo;Terms&rdquo;) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (&ldquo;agreement&rdquo;).<br />
               <br />
               <strong className="text-[20px]">2. Definitions</strong><br />
               <br />
               SERVICE means the learnupindonesia.com website operated by LearnUp.<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">3. Information Collection and Use</strong><br />
               <br />
               We collect several different types of information for various purposes to provide and improve our Service to you.<br />
               <br />
               <strong className="text-[20px]">4. Types of Data Collected</strong><br />
               <br />
               Personal Data<br />
               <br />
               ...
               Usage Data<br />
               <br />
               We may also collect information that your browser sends whenever you visit our Service or when you access Service by or through any device (&ldquo;Usage Data&rdquo;).<br />
               <br />
               This Usage Data may include information such as your computer&rsquo;s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">5. Use of Data</strong><br />
               <br />
               LearnUp uses the collected data for various purposes:<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">6. Retention of Data</strong><br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">7. Transfer of Data</strong><br />
               <br />
               ...
               <br />
               If you are located outside Indonesia and choose to provide information to us, please note that we transfer the data, including Personal Data, to Indonesia and process it there.<br />
               <br />
               ...
               <br />
               0.2.2. to contractors, service providers, and other third parties we use to support our business;<br />
               <br />
               0.2.3. to fulfill the purpose for which you provide it;<br />
               <br />
               0.2.4. for the purpose of including your company&rsquo;s logo on our website;<br />
               <br />
               0.2.5. for any other purpose disclosed by us when you provide the information;<br />
               <br />
               0.2.6. with your consent in any other cases;<br />
               <br />
               0.2.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company, our customers, or others.<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</strong><br />
               <br />
               ...
               <br />
               If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at dewiamida60@gmail.com.<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</strong><br />
               <br />
               ...
               <br />
               0.2. our Privacy Policy link includes the word &ldquo;Privacy&rdquo;, and can easily be found on the home page of our website;<br />
               <br />
               0.3. users will be notified of any privacy policy changes on our Privacy Policy Page;<br />
               <br />
               0.4. users are able to change their personal information by emailing us at dewiamida60@gmail.com.<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</strong><br />
               <br />
               ...
               <br />
               To exercise your California data protection rights described above, please send your request(s) by email: dewiamida60@gmail.com.<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">13. Service Providers</strong><br />
               <br />
               We may employ third party companies and individuals to facilitate our Service (&ldquo;Service Providers&rdquo;), provide Service on our behalf, perform Service-related services or assist us in analysing how our Service is used.<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">17. Links to Other Sites</strong><br />
               <br />
               Our Service may contain links to other sites that are not operated by us. If you click a third party link, you will be directed to that third party&rsquo;s site. We strongly advise you to review the Privacy Policy of every site you visit.<br />
               <br />
               ...
               <br />
               For example, the outlined privacy policy has been made using PolicyMaker.io, a free tool that helps create high-quality legal documents. PolicyMaker&rsquo;s privacy policy generator is an easy-to-use tool for creating a privacy policy for blog, website, e-commerce store or mobile app.<br />
               <br />
               <strong className="text-[20px]">18. Children&rsquo;s Privacy</strong><br />
               <br />
               Our Services are not intended for use by children under the age of 18 (&ldquo;Child&rdquo; or &ldquo;Children&rdquo;).<br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">19. Changes to This Privacy Policy</strong><br />
               <br />
               ...
               <br />
               <strong className="text-[20px]">20. Contact Us</strong><br />
               <br />
               If you have any questions about this Privacy Policy, please contact us by email: dewiamida60@gmail.com.<br />
               <br />
               &nbsp;</p>
               </DocsContent>
            <Footer />
