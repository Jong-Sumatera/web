...
import { bannerTnc } from "../public/images";
    ...
    return (
        <div>
            ...
            <Banner2
                ...
                description={'Read our terms below to learn more about your rights and responsibilities as a LearnUp user.'}
                image={bannerTnc}
            />
            <DocsContent>
                <p>Last updated: 2022-08-31<br />
                    <br />
                    <strong className="text-[20px]">1. Introduction</strong><br />
                    <br />
                    Welcome to LearnUp (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;)!<br />
                    <br />
                    These Terms of Service (&ldquo;Terms&rdquo;, &ldquo;Terms of Service&rdquo;) govern your use of our website located at learnupindonesia.com (together or individually &ldquo;Service&rdquo;) operated by LearnUp.<br />
                    <br />
                    ...
                    <br />
                    If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let us know by emailing at dewiamida60@gmail.com so we can try to find a solution. These Terms apply to all visitors, users and others who wish to access or use Service.<br />
                    <br />
                    <strong className="text-[20px]">2. Communications</strong><br />
                    <br />
                    By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other information we may send. However, you may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or by emailing at dewiamida60@gmail.com.<br />
                    <br />
                    <strong className="text-[20px]">3. Contests, Sweepstakes and Promotions</strong><br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">4. Content</strong><br />
                    <br />
                    Content found on or through this Service are the property of LearnUp or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.<br />
                    <br />
                    <strong className="text-[20px]">5. Prohibited Uses</strong><br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">6. Analytics</strong><br />
                    <br />
                    We may use third-party Service Providers to monitor and analyze the use of our Service.<br />
                    <br />
                    <strong className="text-[20px]">7. No Use By Minors</strong><br />
                    <br />
                    Service is intended only for access and use by individuals at least eighteen (18) years old. By accessing or using Service, you warrant and represent that you are at least eighteen (18) years of age and with the full authority, right, and capacity to enter into this agreement and abide by all of the terms and conditions of Terms. If you are not at least eighteen (18) years old, you are prohibited from both the access and usage of Service.<br />
                    <br />
                    <strong className="text-[20px]">8. Intellectual Property</strong><br />
                    <br />
                    Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of LearnUp and its licensors. Service is protected by copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in connection with any product or service without the prior written consent of LearnUp.<br />
                    <br />
                    <strong className="text-[20px]">9. Copyright Policy</strong><br />
                    <br />
                    ...
                    <br />
                    If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to dewiamida60@gmail.com, with the subject line: &ldquo;Copyright Infringement&rdquo; and include in your claim a detailed description of the alleged Infringement as detailed below, under &ldquo;DMCA Notice and Procedure for Copyright Infringement Claims&rdquo;<br />
                    <br />
                    You may be held accountable for damages (including costs and attorneys&rsquo; fees) for misrepresentation or bad-faith claims on the infringement of any Content found on and/or through Service on your copyright.<br />
                    <br />
                    <strong className="text-[20px]">10. DMCA Notice and Procedure for Copyright Infringement Claims</strong><br />
                    <br />
                    ...
                    <br />
                    You can contact our Copyright Agent via email at dewiamida60@gmail.com.<br />
                    <br />
                    <strong className="text-[20px]">11. Error Reporting and Feedback</strong><br />
                    <br />
                    You may provide us either directly at dewiamida60@gmail.com or via third party sites and tools with information and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters related to our Service (&ldquo;Feedback&rdquo;). You acknowledge and agree that: (i) you shall not retain, acquire or assert any intellectual property right or other right, title or interest in or to the Feedback; (ii) Company may have development ideas similar to the Feedback; (iii) Feedback does not contain confidential information or proprietary information from you or any third party; and (iv) Company is not under any obligation of confidentiality with respect to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due to applicable mandatory laws, you grant Company and its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable, unlimited and perpetual right to use (including copy, modify, create derivative works, publish, distribute and commercialize) Feedback in any manner and for any purpose.<br />
                    <br />
                    <strong className="text-[20px]">12. Links To Other Web Sites</strong><br />
                    <br />
                    Our Service may contain links to third party web sites or services that are not owned or controlled by LearnUp.<br />
                    <br />
                    LearnUp has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.<br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">13. Disclaimer Of Warranty</strong><br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">14. Limitation Of Liability</strong><br />
                    <br />
                    EXCEPT AS PROHIBITED BY LAW, YOU WILL HOLD US AND OUR OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS HARMLESS FOR ANY INDIRECT, PUNITIVE, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGE, HOWEVER IT ARISES (INCLUDING ATTORNEYS&rsquo; FEES AND ALL RELATED COSTS AND EXPENSES OF LITIGATION AND ARBITRATION, OR AT TRIAL OR ON APPEAL, IF ANY, WHETHER OR NOT LITIGATION OR ARBITRATION IS INSTITUTED), WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT, INCLUDING WITHOUT LIMITATION ANY CLAIM FOR PERSONAL INJURY OR PROPERTY DAMAGE, ARISING FROM THIS AGREEMENT AND ANY VIOLATION BY YOU OF ANY FEDERAL, STATE, OR LOCAL LAWS, STATUTES, RULES, OR REGULATIONS, EVEN IF COMPANY HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL BE LIMITED TO THE AMOUNT PAID FOR THE PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES WILL THERE BE CONSEQUENTIAL OR PUNITIVE DAMAGES. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF PUNITIVE, INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE PRIOR LIMITATION OR EXCLUSION MAY NOT APPLY TO YOU.<br />
                    <br />
                    <strong className="text-[20px]">15. Termination</strong><br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">16. Governing Law</strong><br />
                    <br />
                    These Terms shall be governed and construed in accordance with the laws of Indonesia, which governing law applies to agreement without regard to its conflict of law provisions.<br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">17. Changes To Service</strong><br />
                    <br />
                    We reserve the right to withdraw or amend our Service, and any service or material we provide via Service, in our sole discretion without notice. We will not be liable if for any reason all or any part of Service is unavailable at any time or for any period. From time to time, we may restrict access to some parts of Service, or the entire Service, to users, including registered users.<br />
                    <br />
                    <strong className="text-[20px]">18. Amendments To Terms</strong><br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">19. Waiver And Severability</strong><br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">20. Acknowledgement</strong><br />
                    <br />
                    ...
                    <br />
                    <strong className="text-[20px]">21. Contact Us</strong><br />
                    <br />
                    Please send your feedback, comments, requests for technical support by email: dewiamida60@gmail.com.<br />
                    <br />
                    &nbsp;</p>
